...
@section("contenido-header")
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item"><a href="{{route('crear_permiso')}}" class="btn btn-outline-info btn-sm"><i class="fa fa-fw fa-plus-circle"></i> New record</a></li>
    </ol>
    <!-- end breadcrumb -->
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $data)
                                      ...
                                      <tr class="odd gradeX">
                                        ...
                                        <td>{{$data->slug}}</td>
                                        <td>
                                            <a href="{{route('editar_permiso', ['id' => $data->id])}}" class="btn-accion-tabla tooltipsC" title="Edit this record">
