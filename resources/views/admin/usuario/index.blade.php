...
@section("contenido-header")
    ...
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item"><a href="{{route('crear_usuario')}}" class="btn btn-outline-info btn-sm"><i class="fa fa-fw fa-plus-circle"></i> New record</a></li>
    </ol>
    <!-- end breadcrumb -->
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $data)
                                      ...
                                      <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="{{route('editar_usuario', ['id' => $data->id])}}" class="btn-accion-tabla tooltipsC" title="Edit this record">
